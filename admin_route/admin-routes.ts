...
import {allhome_cont,  sub_main_updates_home_cont } from "./home_contend_schema/all_home_fetch";
...
router.put('/all_home_content_update',uplaod.fields([{name:'main_img'},{name:'sub_img'}]),sub_main_updates_home_cont);
